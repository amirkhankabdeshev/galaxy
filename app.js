...
function change_theme() {
   ...
   if (current_background == 'url(/uploads/bg_space.png)') {
       current_background = 'url(/uploads/bg_mars.png)'
   } else {
       current_background = 'url(/uploads/bg_space.png)'
   }
...
let current_background = 'url(/uploads/bg_space.png)'
